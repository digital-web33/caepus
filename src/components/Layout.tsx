  ...
  return (
    <div className="min-h-screen bg-background font-body relative overflow-x-hidden">
      ...
      <main className="relative z-10 pt-[72px]">
          <div className="max-w-[1600px] mx-auto mt-[180px] mb-[120px] bg-background shadow-xl border-t-4 border-b-4 border-[#E0AC4A]">
            {children}
          </div>
      </main>
      ...
      <footer className="bg-primary text-primary-foreground xl:mx-0 relative z-20">
        <div className="max-w-5xl mx-auto px-6 py-14 flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-5 text-[10px] tracking-[0.15em] uppercase text-primary-foreground/40 flex-wrap justify-center">
            ...
            <span>·</span>
            <a href="/politique-confidentialite" className="hover:text-primary-foreground transition-colors">Confidentialité</a>
            <span>·</span>
