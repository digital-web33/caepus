        ...
        <div className="max-w-5xl mx-auto px-8 py-20">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="overflow-hidden rounded-2xl shadow-md border border-primary/10 aspect-[4/3]">
              <img
                src="/uploads/PHOTO PR-compressed.webp"
                alt="Plateaux repas Caepus"
                loading="lazy"
            ...
            <div className="space-y-5">
              ...
              >
                Voir la carte des plateaux repas
              </a>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-8 py-20">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-5">
              ...
              <a
                href="/plaquette/lunchbox"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block mt-2 bg-primary text-primary-foreground px-7 py-3 text-xs tracking-[0.15em] uppercase font-medium hover:bg-primary/90 transition-colors rounded-sm"
              >
                Voir la carte des lunchbox
              </a>
            </div>
